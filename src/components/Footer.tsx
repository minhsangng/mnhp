...
export function Footer() {
  return (
    <footer className="relative px-8 pt-24 pb-2 bg-[url('../../src/assets/images/footer_bg.png')] bg-no-repeat bg-bottom-left bg-auto flex">
      <svg
        viewBox="0 0 1440 80"
      ...
      <div className="w-1/2">
        <div className="bg-linear-to-r from-blue-500/75 to-blue-900 p-1 rounded-3xl">
          <div className="flex">
            <div className="w-1/3! py-4 pl-4 pr-4 border border-gray-300 border-dashed rounded-3xl bg-(--bg-opacity)">
            ...
            <div className="w-2/3 border border-gray-300 border-dashed rounded-3xl bg-(--bg-opacity)">
        ...
        <p className="mt-6! mb-0! text-center text-gray-300">&copy; Bản quyền thuộc về <span className="underline underline-offset-2 text-white italic">Mầm non Hồng Phúc</span> | Design by <a href="https://github.com/minhsangng" className="underline underline-offset-2 text-white italic">minhsang</a>.</p>
      </div>
    </footer>
  );
}
